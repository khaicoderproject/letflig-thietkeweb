...
const Castfun = (castee) => {
  ...
  return `<div class="Now_playing_movies castdiv" >
    <img class="poster" data-id="${castee.id}" src="https://image.tmdb.org/t/p/w500/${castee.profile_path}" loading="lazy" 
        onerror="this.onerror=null;this.src='./resources/D moviesand tv show.png';"
        alt="${castee.original_name}">
...
const Trailerfunc = function (id) {
  return `<iframe class="youtubePlayer" src="https://player.autoembed.cc/embed/tv/${id}" width="100%" height="100%" loading="lazy"  frameborder="0" allowfullscreen></iframe>`;
};
